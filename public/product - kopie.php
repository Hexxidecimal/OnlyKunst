<?php 
  ...
  if(mysqli_connect_errno()){trigger_error('Fout bij verbinding: '.$mysqli->error);}
    ...
    $sql = "SELECT ArtikelID, ArtikelNaam, ArtikelFoto FROM tblArtikel";
    if($stmt = $mysqli->prepare($sql)){
      if(!$stmt->execute()){
        echo 'Het uitvoeren van de query is mislukt: '.$stmt->error.'in query: '.$sql;
      }
      else{
        $stmt->bind_result($ArtikelID, $ArtikelNaam, $ArtikelFoto);
        while($stmt->fetch()){
          $naamTest[$ArtikelID] = ($ArtikelNaam);
          $fotoTest[$ArtikelID] = ($ArtikelFoto);
        }
      }
    }
  }
        ...
        <div class="container">
          <div class="row h-100">
            <div class="col-lg-7 mx-auto text-center mt-7 mb-5">
              <h5 class="fw-bold fs-3 fs-lg-5 lh-sm">Populairste dingen</h5>
            </div><?php $IDNumber = 1 ?>
            <div class="col-12">
                  ...
                  <div class="carousel-item active" data-bs-interval="10000">
                    <div class="row h-100 align-items-center g-2">
                      <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="<?php echo $fotoTest[$IDNumber]; ?>" alt="..." />
                          <div class="card-img-overlay ps-0"> </div>
                          <div class="card-body ps-0 bg-200">
                            <h5 class="fw-bold text-1000 text-truncate"><?php echo $naamTest[$IDNumber]; ?></h5>
        ...
        <div class="container">
          <div class="row h-100">
            <div class="col-lg-7 mx-auto text-center mb-6">
              ...
              <h6 class="fw-bold fs-2 fs-lg-4 lh-sm mb-2">Hier de populairste van alle categoriën</h6>
            </div>
            <div class="col-12">
              <nav>
