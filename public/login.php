              ...
              <div class="bg-holder overlay overlay-light" style="background-image:url(assets/img/gallery/image3.jpeg);background-size:cover;">
                ...
                <?php 
                    ...
                    if(isset($_POST["inloggen"])){
                        if($_POST["login"] == $delogin &&$_POST["Wachtwoord"] == $hetpaswoord){
                            $_SESSION["naam"] = "jan";
                            header("location:beveiliging.php");
                        }
                    }
                ?>
                <div class="container">
                    <div class="row flex-center">
                      <div class="col-6 mb-10" style="background-color:#212121;">
                        <div class="d-flex align-items-center flex-column">
                                ...
                                gebruikersnaam:
                                <label>
                                    <input  class="input-box" type="text" name="gebruikersnaam" value="<?php if(isset($_POST["gebruikersnaam"])){$_POST["gebruikersnaam"] = htmlspecialchars($_POST["gebruikersnaam"]);
                                ...
                                <p style="color:#ffffff; font-size: 200%;">Wachtwoord:
                                <label>
                                    <input  class="input-box" type="text" name="Wachtwoord" value="<?php if(isset($_POST["Wachtwoord"])){$_POST["Wachtwoord"] = htmlspecialchars($_POST["Wachtwoord"]);
                                ...
                                <p>
                                <label>
                                    <div class="d-grid gap-2 d-md-block"><a class="btn btn-lg btn-dark" href="index.html" ib="submit" name="submit" role="button">Login</a></div>
                                    <div class="d-grid gap-2 d-md-block"><a class="btn btn-lg btn-dark" href="registreer.php" role="button">registreer</a></div>
